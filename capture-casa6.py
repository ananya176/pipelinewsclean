...
#        imsize_pix=5000
#        mywsclean(myfile2,niteri,mJythreshold,0,imcellsize,imsize_pix,int_out)
...
#raise Exception("GSB files cannot be subbanded. Make dosubbandselfcal False")
                ...
                myfile2 = [splitavgfilename]
                if usetclean == True:
                        calself(myfile2,ref_ant,scaloops,pcaloops,mJythreshold,imcellsize,imsize_pix,use_nterms,nwprojpl,scalsolints,clipresid,"","",False,niter_start,clean_robust)

#mywsclean(myfile2,niteri,mJythreshold,0,imsize_pix,imcellsize,1)
